...
#ifndef __KOME_OPERATION_CHROMATOGRAM_STD_AFX_H__
#define __KOME_OPERATION_CHROMATOGRAM_STD_AFX_H__
...
namespace kome {
	/// operation namespace
	namespace operation {
		/// Chromatogram Operation plug-in name space
		namespace chrom {
		}
	}
}
...
#endif	// __KOME_OPERATION_CHROMATOGRAM_STD_AFX_H__
