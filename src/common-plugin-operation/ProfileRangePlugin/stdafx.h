...
#ifndef __KOME_OPERATION_RANGE_STD_AFX_H__
#define __KOME_OPERATION_RANGE_STD_AFX_H__
...
namespace kome {
	/// operation namespace
	namespace operation {
		/// Profile Range plug-in name space
		namespace range {
		}
	}
}
...
#endif	// __KOME_OPERATION_RANGE_STD_AFX_H__
