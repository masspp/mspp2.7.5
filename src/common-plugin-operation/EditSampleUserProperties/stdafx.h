...
#ifndef __KOME_EDIT_SAMPLE_USER_PROPERTIES_STD_AFX_H__
#define __KOME_EDIT_SAMPLE_USER_PROPERTIES_STD_AFX_H__
...
#endif	// __KOME_EDIT_SAMPLE_USER_PROPERTIES_STD_AFX_H__
