...
#ifndef __KOME_BATCH_SERVICE_PLUGIN_STD_AFX_H__
#define __KOME_BATCH_SERVICE_PLUGIN_STD_AFX_H__
...
//
	...
	#pragma comment( lib, "IdentificationTools" )	// @date 2013/04/24 <Add> OKADA
...
#include "kome/IdentificationTools.h"	// @date 2013/04/24 <Add> OKADA


#endif	// __KOME_BATCH_SERVICE_PLUGIN_STD_AFX_H__
