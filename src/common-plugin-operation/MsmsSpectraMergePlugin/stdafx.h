...
#ifndef __KOME_MSMS_SPECTRA_MERGE_PLUGIN_STD_AFX_H__
#define __KOME_MSMS_SPECTRA_MERGE_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_MSMS_SPECTRA_MERGE_PLUGIN_STD_AFX_H__
