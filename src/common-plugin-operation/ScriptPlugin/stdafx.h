...
#ifndef __KOME_SCRIPT_PLUGIN_STD_AFX_H__
#define __KOME_SCRIPT_PLUGIN_STD_AFX_H__
...
{	
	...
	std::string strFuncItemName; // short name
} stScriptInfo, *lpScriptInfo;

#endif	// __KOME_SCRIPT_PLUGIN_STD_AFX_H__
