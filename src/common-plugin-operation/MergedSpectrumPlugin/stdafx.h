...
#ifndef __KOME_OPERATION_MERGED_SPECTRUM_STD_AFX_H__
#define __KOME_OPERATION_MERGED_SPECTRUM_STD_AFX_H__
...
namespace kome {
	/// operation namespace
	namespace operation {
		/// merged spectrum plug-in name space
		namespace merged {
		}
	}
}
...
#endif	// __KOME_OPERATION_MERGED_SPECTRUM_STD_AFX_H__
