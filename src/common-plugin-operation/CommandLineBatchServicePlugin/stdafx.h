...
#ifndef __KOME_COMMAND_LINE_BATCH_SERVICE_PLUGIN_STD_AFX_H__
#define __KOME_COMMAND_LINE_BATCH_SERVICE_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_COMMAND_LINE_BATCH_SERVICE_PLUGIN_STD_AFX_H__
