...
#ifndef __KOME_SAMPLE_MERGE_ALIGNMENT_STD_AFX_H__
#define __KOME_SAMPLE_MERGE_ALIGNMENT_STD_AFX_H__
...
#endif	// __KOME_SAMPLE_MERGE_ALIGNMENT_STD_AFX_H__
