...
#ifndef __KOME_SPEC_PEAK_FILTER_NUMBER_OF_PEAKS_PLUGIN_STD_AFX_H__
#define __KOME_SPEC_PEAK_FILTER_NUMBER_OF_PEAKS_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_SPEC_PEAK_FILTER_NUMBER_OF_PEAKS_PLUGIN_STD_AFX_H__
