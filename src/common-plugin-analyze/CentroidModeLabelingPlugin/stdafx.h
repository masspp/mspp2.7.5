...
#ifndef __KOME_LABELING_CENTROID_STD_AFX_H__
#define __KOME_LABELING_CENTROID_STD_AFX_H__
...
namespace kome {
	/// labeling name space
	namespace labeling {
		/// Centroid Mode Labeling namespace
		namespace centroid {
		}
	}
}
...
#endif	// __KOME_LABELING_CENTROID_STD_AFX_H__
