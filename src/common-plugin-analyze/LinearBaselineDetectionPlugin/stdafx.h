...
#ifndef __KOME_BASELINE_LINEAR_STD_AFX_H__
#define __KOME_BASELINE_LINEAR_STD_AFX_H__
...
namespace kome {
	/// baseline namespace
	namespace baseline {
		/// Linear baseline detection namespace
		namespace linear {
		}
	}
}
...
#endif	// __KOME_BASELINE_LINEAR_STD_AFX_H__
