...
#ifndef __KOME_MASBANK_TOOLS_STD_AFX_H__
#define __KOME_MASBANK_TOOLS_STD_AFX_H__
...
//
#ifdef _MSC_VER
	#pragma warning( disable:4099) // no PDB RDKit
...
#endif	// __KOME_MASBANK_TOOLS_STD_AFX_H__
