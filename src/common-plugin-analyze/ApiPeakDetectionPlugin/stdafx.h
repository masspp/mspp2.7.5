...
#ifndef __KOME_API_PEAK_DETECTION_PLUGIN_STD_AFX_H__
#define __KOME_API_PEAK_DETECTION_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_API_PEAK_DETECTION_PLUGIN_STD_AFX_H__
