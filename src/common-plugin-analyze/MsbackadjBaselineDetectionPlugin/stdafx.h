...
#ifndef __KOME_MSBACKADJ_BASELINE_DETECTION_PLUGIN_STD_AFX_H__
#define __KOME_MSBACKADJ_BASELINE_DETECTION_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_MSBACKADJ_BASELINE_DETECTION_PLUGIN_STD_AFX_H__
