...
#ifndef __KOME_LABELING_MULTI_ALGORITHM_STD_AFX_H__
#define __KOME_LABELING_MULTI_ALGORITHM_STD_AFX_H__
...
#endif	// __KOME_LABELING_MULTI_ALGORITHM_STD_AFX_H__
