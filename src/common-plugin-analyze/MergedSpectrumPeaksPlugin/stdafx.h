...
#ifndef __KOME_POSITION_MERGED_SPECTRUM_PEAKS_STD_AFX_H__
#define __KOME_POSITION_MERGED_SPECTRUM_PEAKS_STD_AFX_H__
...
#endif	// __KOME_POSITION_MERGED_SPECTRUM_PEAKS_STD_AFX_H__
