 ...
 * @date 2012.01.25
 * 
 * Copyright(C) 2006-2013 Shimadzu Corporation. All rights reserved.
 */


#ifndef __KOME_GLYCAN_ANALYSIS_PLUGIN_STD_AFX_H__
#define __KOME_GLYCAN_ANALYSIS_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_GLYCAN_ANALYSIS_PLUGIN_STD_AFX_H__
