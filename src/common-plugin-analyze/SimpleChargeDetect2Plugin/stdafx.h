...
#ifndef __KOME_CHARGE_SIMPLE2_STD_AFX_H__
#define __KOME_CHARGE_SIMPLE2_STD_AFX_H__
...
namespace kome {
	/// charge detect namespace
	namespace charge {
		/// Simple Charge Detect plug-in name space
		namespace simple2 {
		}
	}
}
...
#endif	// __KOME_CHARGE_SIMPLE2_STD_AFX_H__
