/**
 * @file MascotPmfSearchEngine.h
 * @brief interfaces of MascotPmfSearchEngine class
 *
 * @author S.Tanaka
 * @date 2012.08.09
 * 
...
#ifndef __KOME_MASCOT_PMF_SEARCH_ENGINE_H__
#define __KOME_MASCOT_PMF_SEARCH_ENGINE_H__
...
namespace kome {
	namespace mascot {
		...
		/**
		 * @fn MascotPmfSearchEngine
		 * @brief mascot PMF search engine class
		 */
		class MascotPmfSearchEngine : public MascotSearchEngineBase {
		public:
			/**
			 * @fn MascotPmfSearchEngine()
			 * @brief constructor
			 */
			MascotPmfSearchEngine();

			/**
			 * @fn virtual ~MascotPmfSearchEngine()
			 * @brief destructor
			 */
			virtual ~MascotPmfSearchEngine();
		...
		protected:
			...
			/** peak path map */
			std::map< kome::ident::SpecInfo*, std::string > m_peaksMap; 
...
#endif    // __KOME_MASCOT_PMF_SEARCH_ENGINE_H__
