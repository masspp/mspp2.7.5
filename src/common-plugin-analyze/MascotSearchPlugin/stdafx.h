...
#ifndef __KOME_MASCOT_SEARCH_PLUGIN_STD_AFX_H__
#define __KOME_MASCOT_SEARCH_PLUGIN_STD_AFX_H__
...
// Indicates whether it is necessary to load Mascot parameters next time the dialog is opened.
extern bool g_bMustLoadMascotParameters;


#endif	// __KOME_MASCOT_SEARCH_PLUGIN_STD_AFX_H__
