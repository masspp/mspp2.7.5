...
#ifndef __KOME_POSITION_LABELING_AND_MERGE_STD_AFX_H__
#define __KOME_POSITION_LABELING_AND_MERGE_STD_AFX_H__
...
#endif	// __KOME_POSITION_LABELING_AND_MERGE_STD_AFX_H__
