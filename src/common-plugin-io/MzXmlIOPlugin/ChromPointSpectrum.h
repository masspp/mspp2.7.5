/**
 * @file ChromPointSpectrum.h
 * @brief interfaces of ChromPointSpectrum class
 *
 * @author S.Tanaka
 * @date 2008.04.23
 * 
...
#ifndef __KOME_IO_MZXML_CHROM_POINT_SPECTRUM_H__
#define __KOME_IO_MZXML_CHROM_POINT_SPECTRUM_H__
...
namespace kome {
	namespace io {
		namespace mzxml {
			...
			/**
			 * @class ChromPointSpectrum
			 * @brief spectrum of chromatogram point management class
			 */
			class ChromPointSpectrum : public kome::objects::Spectrum {
			public:
				/**
				 * @fn ChromPointSpectrum( kome::object::Sample* sample )
				 * @brief constructor
				 * @param sample sample
				 */
				ChromPointSpectrum( kome::objects::Sample* sample );

				/**
				 * @fn virtual ~ChromPointSpectrum()
				 * @brief destructor
				 */
				virtual ~ChromPointSpectrum();
...
#endif		// __KOME_IO_MZXML_CHROM_POINT_SPECTRUM_H__
