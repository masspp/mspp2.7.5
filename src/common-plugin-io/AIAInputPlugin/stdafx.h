...
#ifndef __KOME_A_I_A_INPUT_PLUGIN_STD_AFX_H__
#define __KOME_A_I_A_INPUT_PLUGIN_STD_AFX_H__
...
//
	...
	#pragma comment( lib, "IdentificationTools" )
		...
		#pragma comment( lib, "netCDF" )    //test
...
#endif	// __KOME_A_I_A_INPUT_PLUGIN_STD_AFX_H__
