...
#ifndef __KOME_MATRIX_GROUP_PLOT_STD_AFX_H__
#define __KOME_MATRIX_GROUP_PLOT_STD_AFX_H__
...
namespace kome {
	/// Peak Matrix plug-in name space
	namespace matrix {
		/// groupplot name space
		namespace groupplot {
		}
	}
}
...
#endif	// __KOME_MATRIX_GROUP_PLOT_STD_AFX_H__
