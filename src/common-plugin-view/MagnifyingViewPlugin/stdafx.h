...
#ifndef __KOME_VIEW_MAGNIFYING_VIEW_PLUGIN_STD_AFX_H__
#define __KOME_VIEW_MAGNIFYING_VIEW_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_VIEW_MAGNIFYING_VIEW_PLUGIN_STD_AFX_H__
