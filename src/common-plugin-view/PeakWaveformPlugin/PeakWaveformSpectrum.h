...
#ifndef __KOME_VIEW_PEAK_WAVEFORM_SPECTRUM_H__
#define __KOME_VIEW_PEAK_WAVEFORM_SPECTRUM_H__
...
namespace kome {
	namespace view {
		 ...
		 * @brief raw waveform spectrum class
		 */
		class PeakWaveformSpectrum : public kome::objects::Spectrum {
		public: 
			/**
			 * @fn PeakWaveformSpectrum( kome::objects::Spectrum& spec )
			 * @brief constructor
			 * @param spec
			 */
			PeakWaveformSpectrum( kome::objects::Spectrum& spec );

			/**
			 * @fn virtual ~PeakWaveformSpectrum()
			 * @brief destructor
			 */
			virtual ~PeakWaveformSpectrum();
...
#endif // __KOME_VIEW_PEAK_WAVEFORM_SPECTRUM_H__
