/**
 * @file XYDataViewFunctions.cpp
 * @brief implements of XYPointsView plug-in functions
 *
 * @author S.Tanaka
 * @date 2007.11.12
 * 
...
kome::objects::Variant changeActiveObject( kome::objects::Parameters* params ) {
	...
	}else if( obj.getVariant().type == kome::objects::Variant::SPECTRUM ){
		
		mgr.selectSpectrum( spec );
		
	}else if( obj.getVariant().type == kome::objects::Variant::CHROMATOGRAM ){
...
// check the visibility of the peaks grid
kome::objects::Variant isVisiblePeaksXYData( kome::objects::Parameters* ) {
	...
	// check the visibility
	XYDataViewManager& mgr = XYDataViewManager::getInstance();
	ret.prim.boolVal = mgr.isVisiblePeaksXYPointsView();
...
// toggle peak list view visibility
kome::objects::Variant toggle2dPeaksView( kome::objects::Parameters* ) {
	// return value
	kome::objects::Variant ret;
	ret.type = kome::objects::Variant::BOOL;
	ret.prim.boolVal = true;
	...
	XYDataViewManager& mgr = XYDataViewManager::getInstance();
	mgr.toggleVisibilityOfPeakListView();
