...
#ifndef __KOME_VIEW_STD_AFX_H__
#define __KOME_VIEW_STD_AFX_H__
...
//
	...
	#pragma comment( lib, "EventManager" )	// @date 2011.03.29 <Add> M.Izum
...
#include "kome/EventManager.h"				// @date 2011.03.29 <Add> M.Izum


#endif	// __KOME_VIEW_STD_AFX_H__
