...
#ifndef __KOME_SPEC_CHROM_WIN_MODE_PLUGIN_STD_AFX_H__
#define __KOME_SPEC_CHROM_WIN_MODE_PLUGIN_STD_AFX_H__
...
#endif	// __KOME_SPEC_CHROM_WIN_MODE_PLUGIN_STD_AFX_H__
